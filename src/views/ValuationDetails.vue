<template>
    <div id="background">
        ...
        <div id="filesCo">
            <h3>Pliki dotyczące wyceny</h3>
            <va-divider />
            <div id="filesCoInner" class="file-container-wrapper">
                <div class="file-container">
                    <div v-for="file in files" :key="file.Key" class="file-item">
                        <va-icon v-if="!isReadOnly" color="danger" name="close" id="deleteFile" @click="deleteFile(file)"/>
                ...
                <va-button v-if="!isReadOnly" @click="showFileModal=true" type="button" color="success" gradient>Dodaj plik</va-button>
