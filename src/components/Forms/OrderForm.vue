...
export default {
  ...
  data() {
		return {
            ...
            orderItems: [],
            orderItemsCounter: 0,
            files: [{IdForFileTable: 1, name: "Wzory okładki", fileIcon: "none"},
                    {IdForFileTable: 2, name: "Wzory okładki", fileIcon: "tiff"},
                    {IdForFileTable: 3, name: "Wzory okładki", fileIcon: "doc"},
                    {IdForFileTable: 4, name: "Wzory okładki", fileIcon: "docx"},
                    {IdForFileTable: 5, name: "Wzory okładki", fileIcon: "pdf"},
                    {IdForFileTable: 6, name: "Wzory okładki", fileIcon: "pdf"},
                    {IdForFileTable: 7, name: "Wzory okładki", fileIcon: "pdf"},
                    {IdForFileTable: 8, name: "Wzory okładki", fileIcon: "tiff"},
