  ...
  <div id="mainCo">
		<form @submit.prevent="this.submitForm()">
            ...
            <va-input
                ...
                :rules="[(v) => v.length > 0 || `Pole nazwa nie może być puste.`, (v) => v.length < 255 || `Pole nazwa przekroczyło limit znaków.`]"
                label="Nazwa"
            ...
            <va-input
                ...
                :rules="[(v) => v.length > 0 || `Pole nazwa nie może być puste`, (v) => v.length < 255 || `Pole email przekroczyło limit znaków.`]"
                label="Email"
			...
			<div id="card-container">
				...
				<div class="objects-card-wrapper">
                    ...
                    <va-button type="button" color="success" gradient>Dodaj adres</va-button>
				</div>
			</div>
            <va-input
