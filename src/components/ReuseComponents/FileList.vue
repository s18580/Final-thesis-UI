                ...
                <div v-for="file in files" :key="file.Key" class="file-item" @click="downloadFile(file)">
                    ...
                    <div class="file-icons-wrapper">
                        <div class="file-icons">
                            ...
                            <svg v-if="!checkIfHasProperExtension(file.Key)" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-file-earmark" viewBox="0 0 16 16">
...
export default {
    ...
    methods: {
        ...
        checkIfHasProperExtension(ext){
            return ext.endsWith('csv') || ext.endsWith('doc') || ext.endsWith('docx') || ext.endsWith('tiff') || ext.endsWith('bmp') ||
                   ext.endsWith('ai') || ext.endsWith('jpg') || ext.endsWith('jpeg') || ext.endsWith('gif') || ext.endsWith('xls') ||
                   ext.endsWith('xlsx') || ext.endsWith('png') || ext.endsWith('pdf') || ext.endsWith('svg') || ext.endsWith('txt')
        }
    }
}
</script>
