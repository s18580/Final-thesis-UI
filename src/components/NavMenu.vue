<template>
  <div id="navigationMenu">
    <ul>
      ...
      <li class="nav-menu-item">
        <div @click="rotate($event)" class="px-2 py-3 item-content nonclicable" data-bs-toggle="collapse" data-bs-target="#collapseAccountsMenegment" role="button" aria-expanded="false" aria-controls="collapseExample">
      ...
      <li class="nav-menu-item">
          <div @click="rotate($event)" class="px-2 py-3 item-content nonclicable"  data-bs-toggle="collapse" data-bs-target="#collapseOrders" role="button" aria-expanded="false" aria-controls="collapseExample">
      ...
      <li class="nav-menu-item">
        <div @click="rotate($event)" class="px-2 py-3 item-content nonclicable" data-bs-toggle="collapse" data-bs-target="#collapseClients" role="button" aria-expanded="false" aria-controls="collapseExample">
      ...
      <li class="nav-menu-item">
        <div @click="rotate($event)" class="px-2 py-3 item-content nonclicable" data-bs-toggle="collapse" data-bs-target="#collapseSuppliers" role="button" aria-expanded="false" aria-controls="collapseExample">
      ...
      <li class="nav-menu-item">
        <div @click="rotate($event)" class="px-2 py-3 item-content nonclicable" data-bs-toggle="collapse" data-bs-target="#collapseValuation" role="button" aria-expanded="false" aria-controls="collapseExample">
      ...
      <li class="nav-menu-item">
        <div @click="rotate($event)" class="px-2 py-3 item-content nonclicable" data-bs-toggle="collapse" data-bs-target="#collapseWorker" role="button" aria-expanded="false" aria-controls="collapseExample">
      ...
      <li class="nav-menu-item">
        <div @click="rotate($event)" class="px-2 py-3 item-content nonclicable" data-bs-toggle="collapse" data-bs-target="#collapseStats" role="button" aria-expanded="false" aria-controls="collapseExample">
...
export default {
  ...
  methods: {
    rotate(e) {
      if (e.target.attributes[4].value==='true') {
...
#navigationMenu::-webkit-scrollbar-thumb:hover {
  background: #9aaabe;
}
